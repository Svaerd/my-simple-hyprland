...
run_command "mkdir -p /home/$SUDO_USER/.config/hypr/ && ln --symbolic $BASE_DIR/configs/hypr/hyprland.conf /home/$SUDO_USER/.config/hypr/" "Create symbolic link for hyprland config (Must)" "yes" "no"

run_command "pacman -S --noconfirm xdg-desktop-portal-hyprland" "Install XDG desktop portal for Hyprland" "yes" "no"

run_command "pacman -S --noconfirm hyprpolkitagent" "Install KDE Polkit agent for authentication dialogs" "yes" "no"
...
run_command "pacman -S --noconfirm qt5-wayland qt6-wayland" "Install QT support on wayland" "yes" "no"
